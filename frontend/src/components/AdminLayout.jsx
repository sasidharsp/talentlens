...
import {
  ...
  LogOut, Zap, Briefcase, BarChart2, Activity, MessageSquare, Home, Shield, KeyRound, Info, Network,
} from 'lucide-react';
...
const allNavItems = [
  ...
  { to: '/admin/architecture',  label: 'Architecture',       icon: Network,         roles: ['admin','super_admin'] },
